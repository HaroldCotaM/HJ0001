<%-- 
    Document   : index
    Created on : 03/07/2017, 05:21:37 PM
    Author     : UPEU
--%>
    ...
    <body>
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					<a href="#!" class="btn-sideBar-SubMenu">
						<i class="zmdi zmdi-card zmdi-hc-fw"></i>Control de préstamos <i class="zmdi zmdi-careymentst-down pull-right"></i>
					</a>
					<ul class="list-unstyled full-box">
						<li>
							<a href="registration.html"><i class="zmdi zmdi-money-box zmdi-hc-fw"></i> Préstamos</a>
						</li>
						<li>
							<a href="payments.html"><i class="zmdi zmdi-money zmdi-hc-fw"></i> Devoluciones</a>
						</li>
					</ul>
				</li>
				<li>
					<a href="#!" class="btn-sideBar-SubMenu">
						<i class="zmdi zmdi-shield-security zmdi-hc-fw"></i> Control de Libros <i class="zmdi zmdi-caret-down pull-right"></i>
					</a>
					<ul class="list-unstyled full-box">
						<li>
							<a href="school.html"><i class="zmdi zmdi-balance zmdi-hc-fw"></i>Libros</a>
						</li>
					</ul>
				</li>
			</ul>
